...
- Name: Login.spec.ts >> Login Regression Suite >> LOGIN_E2E_002 - Login with incorrect password  @Regression 
- Location: tests\Login.spec.ts:72:7
      ...
      - generic [ref=f3e138]:
        - generic [ref=f3e139]:
          - generic [ref=f3e140]:
            ...
            - generic [ref=f3e143]: Speed | Tricentis
            - generic:
              - generic [ref=f3e144] [cursor=pointer]: Prev
              - generic [ref=f3e145] [cursor=pointer]: Next
          - generic [ref=f3e176]:
            - generic [ref=f3e177] [cursor=pointer]: "1"
            - generic [ref=f3e178] [cursor=pointer]: "2"
        - generic [ref=f3e179]:
          - heading "Welcome to our store" [level=2] [ref=f3e181]
          - generic [ref=f3e182]:
            - paragraph [ref=f3e183]: Welcome to the new Tricentis store!
            - paragraph [ref=f3e184]: Feel free to shop around and explore everything.
        - generic [ref=f3e185]:
          - strong [ref=f3e187]: Featured products
          - generic [ref=f3e189]:
            - link [ref=f3e191] [cursor=pointer]:
              - /url: /25-virtual-gift-card
              - img "Picture of $25 Virtual Gift Card" [ref=f3e192]
            - generic [ref=f3e193]:
              - heading [level=2] [ref=f3e194]:
                - link "$25 Virtual Gift Card" [ref=f3e195] [cursor=pointer]:
                  - /url: /25-virtual-gift-card
              - generic "915 review(s)" [ref=f3e196]
              - generic [ref=f3e199]:
                - generic [ref=f3e200]: "25.00"
                - button "Add to cart" [ref=f3e203] [cursor=pointer]
          - generic [ref=f3e205]:
            - link [ref=f3e207] [cursor=pointer]:
              - /url: /141-inch-laptop
              - img "Picture of 14.1-inch Laptop" [ref=f3e208]
            - generic [ref=f3e209]:
              - heading [level=2] [ref=f3e210]:
                - link "14.1-inch Laptop" [ref=f3e211] [cursor=pointer]:
                  - /url: /141-inch-laptop
              - generic "1731 review(s)" [ref=f3e212]
              - generic [ref=f3e215]:
                - generic [ref=f3e216]: "1590.00"
                - button "Add to cart" [ref=f3e219] [cursor=pointer]
          - generic [ref=f3e221]:
            - link [ref=f3e223] [cursor=pointer]:
              - /url: /build-your-cheap-own-computer
              - img "Picture of Build your own cheap computer" [ref=f3e224]
            - generic [ref=f3e225]:
              - heading [level=2] [ref=f3e226]:
                - link "Build your own cheap computer" [ref=f3e227] [cursor=pointer]:
                  - /url: /build-your-cheap-own-computer
              - generic "934 review(s)" [ref=f3e228]
              - generic [ref=f3e231]:
                - generic [ref=f3e232]: "800.00"
                - button "Add to cart" [ref=f3e235] [cursor=pointer]
          - generic [ref=f3e237]:
            - link [ref=f3e239] [cursor=pointer]:
              - /url: /build-your-own-computer
              - img "Picture of Build your own computer" [ref=f3e240]
            - generic [ref=f3e241]:
              - heading [level=2] [ref=f3e242]:
                - link "Build your own computer" [ref=f3e243] [cursor=pointer]:
                  - /url: /build-your-own-computer
              - generic "437 review(s)" [ref=f3e244]
              - generic [ref=f3e247]:
                - generic [ref=f3e248]: "1200.00"
                - button "Add to cart" [ref=f3e251] [cursor=pointer]
          - generic [ref=f3e253]:
            - link [ref=f3e255] [cursor=pointer]:
              - /url: /build-your-own-expensive-computer-2
              - img "Picture of Build your own expensive computer" [ref=f3e256]
            - generic [ref=f3e257]:
              - heading [level=2] [ref=f3e258]:
                - link "Build your own expensive computer" [ref=f3e259] [cursor=pointer]:
                  - /url: /build-your-own-expensive-computer-2
              - generic "527 review(s)" [ref=f3e260]
              - generic [ref=f3e263]:
                - generic [ref=f3e264]: "1800.00"
                - button "Add to cart" [ref=f3e267] [cursor=pointer]
          - generic [ref=f3e269]:
            - link [ref=f3e271] [cursor=pointer]:
              - /url: /simple-computer
              - img "Picture of Simple Computer" [ref=f3e272]
            - generic [ref=f3e273]:
              - heading [level=2] [ref=f3e274]:
                - link "Simple Computer" [ref=f3e275] [cursor=pointer]:
                  - /url: /simple-computer
              - generic "410 review(s)" [ref=f3e276]
              - generic [ref=f3e279]:
                - generic [ref=f3e280]: "800.00"
                - button "Add to cart" [ref=f3e283] [cursor=pointer]
  - generic [ref=f3e284]:
    - generic [ref=f3e285]:
      - generic [ref=f3e286]:
        - heading "Information" [level=3] [ref=f3e287]
        - list [ref=f3e288]:
          - listitem [ref=f3e289]:
            - link "Sitemap" [ref=f3e290] [cursor=pointer]:
              - /url: /sitemap
          - listitem [ref=f3e291]:
            - link "Shipping & Returns" [ref=f3e292] [cursor=pointer]:
              - /url: /shipping-returns
          - listitem [ref=f3e293]:
            - link "Privacy Notice" [ref=f3e294] [cursor=pointer]:
              - /url: /privacy-policy
          - listitem [ref=f3e295]:
            - link "Conditions of Use" [ref=f3e296] [cursor=pointer]:
              - /url: /conditions-of-use
          - listitem [ref=f3e297]:
            - link "About us" [ref=f3e298] [cursor=pointer]:
              - /url: /about-us
          - listitem [ref=f3e299]:
            - link "Contact us" [ref=f3e300] [cursor=pointer]:
              - /url: /contactus
      - generic [ref=f3e301]:
        - heading "Customer service" [level=3] [ref=f3e302]
        - list [ref=f3e303]:
          - listitem [ref=f3e304]:
            - link "Search" [ref=f3e305] [cursor=pointer]:
              - /url: /search
          - listitem [ref=f3e306]:
            - link "News" [ref=f3e307] [cursor=pointer]:
              - /url: /news
          - listitem [ref=f3e308]:
            - link "Blog" [ref=f3e309] [cursor=pointer]:
              - /url: /blog
          - listitem [ref=f3e310]:
            - link "Recently viewed products" [ref=f3e311] [cursor=pointer]:
              - /url: /recentlyviewedproducts
          - listitem [ref=f3e312]:
            - link "Compare products list" [ref=f3e313] [cursor=pointer]:
              - /url: /compareproducts
          - listitem [ref=f3e314]:
            - link "New products" [ref=f3e315] [cursor=pointer]:
              - /url: /newproducts
      - generic [ref=f3e316]:
        - heading "My account" [level=3] [ref=f3e317]
        - list [ref=f3e318]:
          - listitem [ref=f3e319]:
            - link "My account" [ref=f3e320] [cursor=pointer]:
              - /url: /customer/info
          - listitem [ref=f3e321]:
            - link "Orders" [ref=f3e322] [cursor=pointer]:
              - /url: /customer/orders
          - listitem [ref=f3e323]:
            - link "Addresses" [ref=f3e324] [cursor=pointer]:
              - /url: /customer/addresses
          - listitem [ref=f3e325]:
            - link "Shopping cart" [ref=f3e326] [cursor=pointer]:
              - /url: /cart
          - listitem [ref=f3e327]:
            - link "Wishlist" [ref=f3e328] [cursor=pointer]:
              - /url: /wishlist
      - generic [ref=f3e329]:
        - heading "Follow us" [level=3] [ref=f3e330]
        - list [ref=f3e331]:
          - listitem [ref=f3e332]:
            - link "Facebook" [ref=f3e333] [cursor=pointer]:
              - /url: http://www.facebook.com/nopCommerce
          - listitem [ref=f3e334]:
            - link "Twitter" [ref=f3e335] [cursor=pointer]:
              - /url: https://twitter.com/nopCommerce
          - listitem [ref=f3e336]:
            - link "RSS" [ref=f3e337] [cursor=pointer]:
              - /url: /news/rss/1
          - listitem [ref=f3e338]:
            - link "YouTube" [ref=f3e339] [cursor=pointer]:
              - /url: http://www.youtube.com/user/nopCommerce
          - listitem [ref=f3e340]:
            - link "Google+" [ref=f3e341] [cursor=pointer]:
              - /url: https://plus.google.com/+nopcommerce
    - generic [ref=f3e342]:
      - text: Powered by
      - link "nopCommerce" [ref=f3e343] [cursor=pointer]:
        - /url: http://www.nopcommerce.com/
    - generic [ref=f3e344]: Copyright © 2026 Tricentis Demo Web Shop. All rights reserved.
```
